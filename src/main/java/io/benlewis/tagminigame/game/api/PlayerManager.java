 ...
 * {@link PlayerWrapper}. Given a {@link Player}, the manager will create a new instance of the wrapper, mapped to by
 * the players UUID. The manager can then perform contains, get and remove queries on the internal map.
 */
public interface PlayerManager {

    /**
     * Create an {@link PlayerWrapper} for a {@link Player} registered with this manager. Throws
     ...
     */
    PlayerWrapper register(Player player);

    /**
     * Remove a {@link Player} and associated {@link PlayerWrapper} wrapper from the manager.
    ...
    /**
     * Query whether an {@link PlayerWrapper} wrapper exists for the given {@link Player}.
    ...
    /**
     * Query whether an {@link PlayerWrapper} wrapper exists for a given {@link Player}.
    ...
    /**
     * Get the {@link PlayerWrapper} wrapper for a given {@link Player}. Throws {@link java.util.NoSuchElementException} if
     * the players {@link UUID} is not registered in this manager.
     * @param player to get wrapper of
     * @return the wrapper of the player
     */
    PlayerWrapper get(Player player);
